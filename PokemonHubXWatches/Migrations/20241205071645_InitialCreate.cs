        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeldItemName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PokemonRole = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PokemonStyle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Watches_Pokemons_PokemonID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeldItemId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    ItemLevel = table.Column<int>(type: "int", nullable: false, defaultValue: 1)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildHeldItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildHeldItems_Builds_BuildId",
                        column: x => x.BuildId,
                        principalTable: "Builds",
                        principalColumn: "BuildId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BuildHeldItems_HeldItems_HeldItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildHeldItems_BuildId_HeldItemId",
                table: "BuildHeldItems",
                columns: new[] { "BuildId", "HeldItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BuildHeldItems_HeldItemId",
                table: "BuildHeldItems",
                column: "HeldItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HeldItems_HeldItemName",
                table: "HeldItems",
                column: "HeldItemName",
                unique: true);
